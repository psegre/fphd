...
To save time, copy from the `.solutions/` directory the `Inverter.vhd` source file:

```
% cp .solutions/Inverter.vhd .
```
...
* add the `Inverter.vhd` VHDL file to the project
...
add_files -norecurse -fileset sources_1 Inverter.vhd
