#
# Xilinx implementation constraints for Sinusoidal Pulse-Width Modulator (SPWM).
#
#
...
## map PWM output to pin header IO26
set_property -dict { PACKAGE_PIN U11 IOSTANDARD LVCMOS33 } [get_ports pwm_out]
...
set_load 10 [get_ports pwm_out] -verbose
